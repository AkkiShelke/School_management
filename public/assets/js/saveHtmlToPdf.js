					...
					function convert(theElement , id) {
				        ...
				        html2canvas(quotes, {
				            ...
				            for (var i = 0; i <= quotes.clientHeight/980; i++) {
				                ...
				                onePageCanvas.setAttribute('width', 910);
...
//                                pdf.addFont('MarathiLekhani.ttf', 'Marathi Lekhani', 'normal');
//pdf.setFont('Marathi Lekhani');
//pdf.text(50,50,'महाराष्ट्र शिक्षण मंडळ');
